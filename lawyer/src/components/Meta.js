  ...
  return (
    <>
      <Head>
        ...
        <meta name='description' content='Юридична допомога Львів Україна' />
        <meta name='viewport' content='width=device-width, initial-scale=1' />
        <link rel='icon' href='https://icons8.com/icon/3Y1TWBsp0hGM/scales' />
        <link
          rel='icon'
          type='image/png'
          sizes='32x32'
          href='https://cdn-icons-png.flaticon.com/512/3122/3122427.png'
        />
        <link
          rel='icon'
          type='image/png'
        ...
        <meta property='og:site_name' content='Юридична допомога'></meta>
        <meta property='og:type' content='article'></meta>
        <meta
          property='og:title'
          content='допомога адвоката Львів Україна'></meta>
        <meta
